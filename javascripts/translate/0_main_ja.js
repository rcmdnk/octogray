(function() {
    ...
    function dc(a, b, c) {
        ...
        for (var d; a[A] && (d = a[Ia]());)
            if (!a[A] && b !== m) c[d] = b;
            else c = c[d] ? c[d] : c[d] = {}
    }

    function ec(a, b) {
        for (var c = a[Wa]("."), d = b || S, e; e = c[Ia]();)
            if (d[e]) d = d[e];
            else return j;
        return d
    }
    ...
    var sc = google[Kb]._const,
        ...
        yc;
    a: {
        for (var zc = u[Wb]("meta"), Ac = 0; Ac < zc[A]; ++Ac)
            if (zc[Ac][Pb] == "google-translate-customization") {
                yc = zc[Ac].content;
                break a
            }
        yc = ""
    ...
    function md(a) {
        for (var b = 1; b < arguments[A]; b++) {
            ...
            if (ic(c) || (d = jc(c)) && c[eb]("callee")) a[y][Jb](a, c);
                ...
                for (var e = a[A], f = c[A], g = 0; g < f; g++) a[e + g] = c[g];
            else a[y](c)
        }
    }
    ...
    function te(a) {
        if (a && typeof a[A] == "number")
            if (mc(a)) return typeof a[bb] == "function" || typeof a[bb] == "string";
    ...
    function Ne(a, b, c) {
        ...
        a.button = b.button;
        a.keyCode = b[vb] || 0;
        a.charCode = b.charCode || (d == "keypress" ?
            b[vb] : 0);
        a.ctrlKey = b.ctrlKey;
        a.altKey = b.altKey;
    ...
    function rf(a, b, c, d, e) {
        ...
        if (!a) return l;
        for (f = 0; f < a[A]; f++)
            if (a[f].Va == c && a[f].hb == d && a[f].Bb == e) return tf(a[f].ga);
        return l
    }
    ...
    function Kf(a) {
        var b = new zf(0, Infinity, Infinity, 0),
            ...
            f;
        for (a = a; a = Jf(a);)
            if ((!W || a[Oa] != 0) && (!Ld || a[yb] != 0 || a != d) && (a.scrollWidth != a[Oa] || a.scrollHeight != a[yb]) && Ff(a, "overflow") != "visible") {
                var g = Lf(a),
                    k;
                k = a;
                if (Kd && !ae("1.9")) {
    ...
    function Y(a, b, c, d, e, f) {
        if (ic(c))
            for (var g = 0; g < c[A]; g++) Y(a, b, c[g], d, e, f);
        else {
    ...
    function ag(a, b, c, d, e, f) {
        if (a.b || a.a)
            if (ic(c))
                for (var g = 0; g < c[A]; g++) ag(a, b, c[g], d, e, f);
            else {
                a: {
                    d = d || a;
                    f = f || a.c || a;
    ...
    R.dispatchEvent = function(a) {
        ...
        if (d in e) {
            ...
            if (f = l in e) {
                ...
                f.ca = f.o;
                if (d)
                    for (g = 0; !a.a && g < c[A] && f.ca; g++) {
                        ra(a, c[g]);
                        b &= wf(f, c[g], a[Hb], l, a) && a.b != l
                    } else
                        for (c = this; !a.a && c && f.ca; c = c.Hb) {
                            ra(a, c);
                            b &= wf(f, c,
                                a[Hb], l, a) && a.b != l
                        }
    ...
    if (Ve) {
        ...
        this.a += a;
        if (b != j)
            for (var c = 1; c < arguments[A]; c++) this.a += arguments[c];
        return this
    };
    mg[C].clear = function() {
        if (Ve) {
    ...
    function pg(a, b) {
        var c = b || new ng;
        c.H('<head><meta http-equiv="Content-Type" content="text/html; charset=UTF8"><link rel="stylesheet" type="text/css" href="', a.A, '"></head><body class="goog-te-banner" scroll="no" border=0 dir="', a.dir, '"><table border=0 cellspacing=0 cellpadding=0 width=100% height=100%><tr valign=middle><td width=1 nowrap><a href="', a.fc, '" class="goog-logo-link" target="_blank"><img src="', a.Fa, '" alt="Google ', "\u7ffb\u8a33", '"></a></td>', a.Ha ? '<td width=1><img src="' + a.Aa + '" width="9" height="15" title="' +
            a.Ha + '" alt="' + a.Ha + '" style="background-image:url(' + a.Sa + ');background-position:-56px 0px;margin:0 4px"></td>' : "", '<td class="goog-te-banner-margin"></td><td><table border=0 cellspacing=0 cellpadding=0 height=100%><tr id="', a.Td, '" style="display:none" valign=middle><td nowrap><span class="goog-te-banner-content">', a.Sd, '</span></td><td class="goog-te-banner-margin"></td><td nowrap><div class="goog-te-button"><div><button id="', a.ad, '"><b>', "\u7ffb\u8a33", '</b></button></div></div></td><td class="goog-te-banner-margin"></td><td nowrap><div class="goog-te-button"><div><button id="',
            a.Nd, '"></button></div></div></td></tr><tr id="', a.Rd, '" style="display:none" valign=middle><td><span class="goog-te-banner-content">', "\u7ffb\u8a33\u4e2d", '&nbsp;<span dir="ltr">(<b id="', a.Qd, '"></b>%)</span>&nbsp;<img src="', a.Ld, '"></span></td><td class="goog-te-banner-margin"></td><td nowrap><div class="goog-te-button"><div><button id="', a.Zc, '">', "\u30ad\u30e3\u30f3\u30bb\u30eb", '</button></div></div></td></tr><tr id="', a.gd, '" style="display:none"><td><span class="goog-te-banner-content">',
            a.fd, '</span></td><td class="goog-te-banner-margin"></td><td nowrap><div class="goog-te-button"><div><button id="', a.Ud, '">', "\u539f\u6587\u3092\u8868\u793a", '</button></div></div></td></tr><tr id="', a.ed, '" style="display:none" valign=middle><td><span id="', a.dd, '" class="goog-te-banner-content"></span></td></tr></table></td><td width=1><a href="', a.Kd, '" target="_blank" style="white-space:nowrap">', "\u8a73\u7d30", '</a></td><td width=1><a id="', a.$c, '" class="goog-close-link" href="javascript:void(0)" title="',
            "\u9589\u3058\u308b", '"><img src="', a.Aa, '" width="15" height="15" alt="', "\u9589\u3058\u308b", '" style="background-image:url(', a.Sa, ');background-position:-28px 0px"></a></td></tr></table></body>');
        if (!b) return c[z]()
    }
    ...
    function ug(a, b) {
        var c = b || new ng;
        c.H('<head><meta http-equiv="Content-Type" content="text/html; charset=UTF8"><link rel="stylesheet" type="text/css" href="', a.A, '"></head><body scroll="no" style="margin:0px;overflow:hidden" dir="', a.dir, '" marginHeight=0 marginWidth=0 leftMargin=0 topMargin=0 border=0><div id="content" class="goog-te-balloon"><table border=0 cellspacing=0 cellpadding=0 width=100%><tr valign=middle><td nowrap><b>', "\u539f\u6587:", '</b></td><td id="logo" width=1 nowrap>', a.cc ? "<span style=\"display:inline-block;vertical-align:middle;height:15px; width:51px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader( src='" +
            a.Fa + "',sizingMethod='scale');\"></span>" : '<img src="' + a.Fa + '">', '</td><td width=8></td><td width=1 nowrap><a id="close" href="javascript:void(0)" title="', "\u9589\u3058\u308b", '"><img src="', a.Aa, '" width="15" height="15" style="background-image:url(', a.Sa, ');background-position:-28px 0px"></a></td></tr></table><div id="original" class="goog-te-balloon-text"></div><div id="zippy" class="goog-te-balloon-zippy" style="display:none"><img id="zippy_img" class="plus" width="12" height="12" src="', a.Aa,
            '"><span>', "\u7ffb\u8a33\u3092\u6539\u5584\u3059\u308b", '</span></div><div id="feedback" style="display:none"><iframe name="feedback-frame" frameBorder=0 style="width:100%;display:none"></iframe></div><div class="goog-te-balloon-form" style="display:none"><form id="suggestForm" target="feedback-frame" method="post"><input type="hidden" name="gtrans"><input type="hidden" name="hl"><input type="hidden" name="text"><input type="hidden" name="langpair"><input type="hidden" name="oe" value="UTF-8">');
        for (var d = a.aa, e = d[A], f = 0; f < e; f++) {
            var g = d[f];
            c.H('<input type="hidden" name="', g, '" />')
        }
        c.H('<textarea rows="3" name="utrans"></textarea><div style="text-align:', a.dir == "rtl" ? "left" : "right", '"><input type="submit" value="', "\u9001\u4fe1", '"></div></form></div><div id="forward" class="goog-te-balloon-footer" style="display:none"><a id="forward_link" href="javascript:void(0)">', "\u7ffb\u8a33\u3092\u6539\u5584\u3059\u308b", "</a></div></div></body>");
        if (!b) return c[z]()
    };
    ...
    function Ig(a) {
        ...
        for (var c in a)
            if (a[c] !== r[C][c]) {
                var d = Vc(c);
                if (hc(a[c]) == "array")
                    for (var e = 0; e < a[c][A]; ++e) b[y](d + "=" + Vc(a[c][e]));
                else b[y](d + "=" + Vc(a[c]))
            }
        return b[Vb]("&")
    }
            ...
            for (var e = d[M]; e; e = e[Sb])
                ...
                if (a.a[A] == 1) b.$[y]({
                    ...
                    for (var f = {}, g = -1, k = function(s, t, U) {
                        ...
                        if (o.attributes && o.attributes.i) {
    ...
    xa(Xg[C], function() {
        if (this.f) {
            ...
            $g(this);
            for (a = 0; a < this.a[A]; ++a)
                if (this.j[a] && this.a[a]) {
                    ...
                    if (this.b[a]) {
                        ...
                        var c = void 0,
                            d = b[P];
                        if (d && d[Ua] != 11)
                            if (b.removeNode) b.removeNode(l);
                            else {
                                for (; c = b[M];) d[cb](c, b);
                                ye(b)
                            }
    ...
    R.wa = function(a) {
        if (this.h[$a] != a)
            for (var b = 0, c; c = this.h.options[bb](b); ++b)
                if (c[$a] == a) {
    ...
    R.ce = function() {
        ...
        pa(this.a.n(Z(this, "errorContent")), "\u30a8\u30e9\u30fc: \u30b5\u30fc\u30d0\u30fc\u3067\u30ea\u30af\u30a8\u30b9\u30c8\u3092\u51e6\u7406\u3067\u304d\u307e\u305b\u3093\u3067\u3057\u305f\u3002\u3057\u3070\u3089\u304f\u3057\u3066\u304b\u3089\u3082\u3046\u4e00\u5ea6\u304a\u8a66\u3057\u304f\u3060\u3055\u3044\u3002");
        if (this.e.A == Kc) {
            var a = "url(" + Ec + ")";
            Bf(this.a.a[I], "backgroundImage", a);
            for (var b = this.a.a[Wb]("button"), c = 0; c < b[A]; ++c) {
                Bf(b[c][P], "backgroundImage",
                    a);
        ...
        Y(this.d, this.a.n(Z(this, "confirm")), "click", Gg(this, "clk_confirm"));
    ...
    R.P = function(a) {
        if (this.f != a) {
            ...
            if (a) {
                ...
                X(this.h, l);
                if (d &&
                    c >= 40) this.b.a[I].topMargin = c - 40
            }
        }
    };
    ...
    R.t = function() {
        ...
        if (this.e.Ta == 2) pa(this.h, rg({
            ...
            b.H('<span style="white-space:nowrap"><a class="goog-logo-link" href="', a.fc, '" target="_blank">', a.cc ? "<span style=\"display:inline-block;vertical-align:middle;height:15px; width:51px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader( src='" + a.Fa +
                "',sizingMethod='scale');\"></span>" : '<img src="' + a.Fa + '">', "\u7ffb\u8a33", "</a></span>");
            a = b[z]();
            a = a = "Powered by " + a;
            pa(this.h, rg({
                id: Z(this, "targetLanguage"),
    ...
    si[C].log = function(a, b, c) {
        if (a[$a] >= yi(this)[$a]) {
            ...
            for (b = this; b;) {
                ...
                var d = a;
                if (c.d)
                    for (var e = 0, f = void 0; f = c.d[e]; e++) f(d);
                b = b.a
            }
        }
    };
    ...
    function Ri(a) {
        if (a.za)
            if (typeof cc != "undefined")
                if (a.Pb[1] && Si(a) == 4 && Ti(a) == 2) zi(a.U, Ni(a, "Local request error detected and ignored"));
    ...
    function Wi(a, b) {
        this.cb = new Jh(a);
        if (b)
            for (var c in b) b[c] !== r[C][c] && ai(this.cb, c, b[c])
    }
    V(Wi, Qc);
    za(Wi[C], function() {
        return i
    ...
    function sj(a) {
        for (var b = 3 + a.B; a.F < a.a[A] && a.F < b; ++a.F) {
            var c = a,
                ...
                g = [];
            if (e.la)
                for (var k = 0; k < e.la[A]; ++k) g[y](e.la[k].ka);
            else g[y](e.content);
    ...
    R.Dd = function(a, b, c) {
        ...
        if (this.D && a) {
            if (c != 200) this.b.add(T(this.O, this, this.K, l, i));
                ...
                var d = [];
                for (c = 0; c < b[A] && c < a.la[A]; ++c)
                    if (b[c] && b[c][1] && b[c][1] == 200) {
                        var e = b[c][0],
    ...
    function zj(a, b) {
        ...
        this.ia = {
            A: Kc,
            Ha: d ? "\u3053\u306e\u4fdd\u8b77\u3055\u308c\u305f\u30da\u30fc\u30b8\u306e\u5185\u5bb9\u306f\u3001\u30bb\u30ad\u30e5\u30ea\u30c6\u30a3\u3067\u4fdd\u8b77\u3055\u308c\u305f\u63a5\u7d9a\u3092\u4f7f\u7528\u3057\u3066 Google \u306b\u9001\u4fe1\u3055\u308c\u3001\u7ffb\u8a33\u3055\u308c\u307e\u3059\u3002" : j
        };
        this.e.Ob = d;
        this.O = {
            A: Kc,
        ...
        if (c) {
            ...
            "multilanguagePage" in
            c && (this.e.Xa = ca(c.multilanguagePage));
            ...
            if ("useSecureConnection" in c) {
                ...
                this.ia.Ha = this.e.Ob ? "\u3053\u306e\u4fdd\u8b77\u3055\u308c\u305f\u30da\u30fc\u30b8\u306e\u5185\u5bb9\u306f\u3001\u30bb\u30ad\u30e5\u30ea\u30c6\u30a3\u3067\u4fdd\u8b77\u3055\u308c\u305f\u63a5\u7d9a\u3092\u4f7f\u7528\u3057\u3066 Google \u306b\u9001\u4fe1\u3055\u308c\u3001\u7ffb\u8a33\u3055\u308c\u307e\u3059\u3002" :
                    j
            }
    ...
    R.wd = function(a) {
        ...
        this.l[tc] = "";
        this.N[tc] = "";
        for (var d in this.B.tl)
            if (this.B.tl[d] !== r[C][d])
                if ((a || d in b) && !(d in c)) {
    ...
    R.xd = function() {
        ...
        if (this.B) {
            ...
            if (this.b) {
                ...
                for (b in c)
                    if (c[b] !== r[C][b]) d[b] = c[b];
                this.b.mc(d, this.N);
                this.b.V("")
            }
            if (!vc && a)
                if (this.e.ub) Cg(this.K, Ag(this.D,
                    T(this.Jb, this, i, i)))[L]();
                else {
                    this.F = i;
    ...
    R.Fc = function() {
        if (this.a.fa())
            if (!this.e.Xa && this.c == this.a.ba()) this.ac();
            else {
    ...
    R.vd = function() {
        if (this.b.ba())
            if (!this.e.Xa && this.c == this.b.ba()) this.ac();
            else {
                this.d = this.b.ba();
                this.a.V(this.d);
                Cj(this)
